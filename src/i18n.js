...
const MESSAGES = Object.freeze({
  en: Object.freeze({
    ...
    'scene.zoomHelp': 'Mouse wheel: zoom. Hold the left mouse button or Shift while wheeling to scroll the document. Arrow keys: zoom.',
    'boot.initialising': 'Initialising',
    'intro.skip': 'Skip intro',
    'card.abschluss.title': 'Final Project',
    'card.abschluss.subtitle': 'Server · UEM · Migration',
    'card.projekte.title': 'IT Projects',
    'card.projekte.subtitle': 'Websites · Systems integration',
    ...
    'footer.resumeLead': 'Mouse wheel: zoom ·',
    ...
    'card.finalProject.subtitle': 'Server · UEM · Migration',
    'card.projects.title': 'IT PROJECTS',
    'card.projects.subtitle': 'Websites · Systems integration',
    'card.cv.title': 'CV',
    'card.cv.subtitle': 'Career · Skills · Contact',
  }),
  de: Object.freeze({
    ...ihkMessages.de,
    ...exampleMessages.de,
    ...projectWingsMessages.de,
    'scene.zoomHelp': 'Mausrad: Zoom. Linke Maustaste oder Umschalt gedrückt halten und das Rad bewegen, um im Dokument zu blättern. Pfeiltasten: Zoom.',
    ...
    'card.projekte.subtitle': 'Webseiten · Systemintegration',
    'card.lebenslauf.title': 'Lebenslauf',
    'card.lebenslauf.subtitle': 'Werdegang · Kontakt',
    ...
    'footer.resumeLead': 'Mausrad: Zoom ·',
    ...
    'card.projects.subtitle': 'Webseiten · Systemintegration',
    'card.cv.title': 'LEBENSLAUF',
    'card.cv.subtitle': 'Werdegang · Kontakt',
  }),
});
